...
write_csv(
  relevant_trials %>%
    filter(
      str_detect(
        glue("{primary_sponsor_simple} {leading_institution_simple}"),
        "Basel|Bern|Zürich|Genf|Lausanne"
      )
    ) %>%
    arrange(end_date, leading_institution_simple),
  "./output/Basel_Bern_Zürich_Genf_Lausanne.csv"
)
